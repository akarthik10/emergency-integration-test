...
#import "GGFilterElementGroup.h"

@protocol GGFilterSettingsDelegate;
@interface GGFilterSettingsView : UIView

@property (nonatomic, weak) id<GGFilterSettingsDelegate> delegate;
...
@protocol GGFilterSettingsDelegate <NSObject>

-(void)filterSettings:(GGFilterSettingsView *)view didSelectFilterElements:(NSArray *)elements enabled:(BOOL)enabled;
